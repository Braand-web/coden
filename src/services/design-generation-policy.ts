...
const antiAiDesignRules = [
  ...
  'AESTHETIC DIRECTION: commit to one deliberate direction that fits the product (calm operational, editorial, refined minimal, warm local-business, fintech sober, technical/devtool, playful consumer, immersive creative). Subtle layered background tints separate zones; avoid flat pure-var(--surface) or pure-var(--foreground) slabs unless the direction is deliberately stark.',
