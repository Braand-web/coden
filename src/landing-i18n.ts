...
const FR: Record<string, string> = {
  ...
  'pricing.free.f1': '5 crédits Build par jour, 30 par mois',
  'pricing.free.f2': '1 projet actif',
  'pricing.free.f3': 'Aperçu en direct pendant la création',
  'pricing.free.f4': '20 crédits Cloud et 4 crédits IA mensuels',
  'pricing.free.f5': 'Sous-domaine Coden',
  ...
  'pricing.pro.f1': 'Dès 100 crédits / mois',
  'pricing.pro.f2': 'Paliers jusqu’à 10 000 crédits',
  'pricing.pro.f3': '20 crédits Cloud et 4 crédits IA mensuels',
  ...
  'pricing.scale.f1': 'Dès 100 crédits / mois',
  'pricing.scale.f2': 'Paliers jusqu’à 10 000 crédits',
  'pricing.scale.f3': '20 crédits Cloud et 4 crédits IA mensuels',
