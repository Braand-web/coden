...
function installStyle() {
  ...
  style.textContent = `
    ...
    .connectors-main{min-width:0;min-height:0;display:grid;grid-template-rows:auto minmax(0,1fr);background:var(--bg-surface,#0f172a)}
    ...
    .connectors-intro::after{content:"";position:absolute;inset:0;background:linear-gradient(to bottom,rgba(25,25,25,.12),rgba(25,25,25,.68) 52%,var(--bg-surface,#0f172a) 92%);pointer-events:none}
    ...
    .connector-detail{position:absolute;inset:0;z-index:5;display:grid;grid-template-rows:auto minmax(0,1fr);background:color-mix(in srgb,var(--bg-surface,#0f172a) 97%,transparent);backdrop-filter:blur(18px);transform:translateX(102%);transition:transform 220ms cubic-bezier(.22,1,.36,1)}.connector-detail.open{transform:translateX(0)}
