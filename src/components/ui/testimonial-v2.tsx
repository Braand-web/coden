...
// --- Standalone demo shell (dark-mode toggle + full-page layout) ---
// Kept for parity with the delivered component and for isolated preview;
// the real landing page mounts `TestimonialsSection` directly and defers
// to the site's own theme toggle instead of this local one.
